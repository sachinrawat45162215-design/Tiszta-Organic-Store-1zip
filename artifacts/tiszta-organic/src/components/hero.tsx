      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 text-[#0d2416]">
              From Soil to <span className="text-primary italic">Soul.</span>
            </h1>
            
            <p className="text-lg md:text-xl text-[#2a4030] mb-8 leading-relaxed max-w-xl font-medium">
